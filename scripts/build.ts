...
🔗 **[立即访问 →](https://Quantum404Void.github.io/daily-news-site)**
...
每日由 [小新](https://github.com/Quantum404Void) 通过脚本自动采集、生成、构建并推送。
...
async function main() {
  ...
  const ok = gitPush();
  if (ok) {
    console.log("✅ Done → https://Quantum404Void.github.io/daily-news-site");
  } else {
